...
public class DownloadService extends Service {
	...
	/* 下载包安装路径 */
	private static final String savePath =Environment.getExternalStorageDirectory() +"/studentsos/updateApk/";

	private static final String saveFileName = savePath + "studnetsos.apk";
	...
	public IBinder onBind(Intent intent) {
		...
		apkUrl=intent.getStringExtra("url");//获取下载地址
		return binder;
	}
