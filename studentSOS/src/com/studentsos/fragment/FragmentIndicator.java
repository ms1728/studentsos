...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private static final int COLOR_SELECT = Color.parseColor("#999999");
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.tab_icon_book_dark,
				R.string.tab_home, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.drawable.tab_icon_search_dark,
				R.string.tab_search, COLOR_SELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.tab_icon_hot_dark,
				R.string.tab_hot, COLOR_SELECT, TAG_ICON_2, TAG_TEXT_2);
		mIndicators[2].setTag(Integer.valueOf(2));
		mIndicators[2].setOnClickListener(this);
		addView(mIndicators[2]);
		mIndicators[3] = createIndicator(R.drawable.tab_icon_me_dark,
				R.string.tab_me, COLOR_SELECT, TAG_ICON_3, TAG_TEXT_3);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.tab_icon_book_dark);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.tab_icon_search_dark);
			prevText = (TextView) mIndicators[mCurIndicator]
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.tab_icon_hot_dark);
			prevText = (TextView) mIndicators[mCurIndicator]
		...
		case 3:
			...
			prevIcon.setImageResource(R.drawable.tab_icon_me_dark);
			prevText = (TextView) mIndicators[mCurIndicator]
		...
		case 0:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_0);
			currIcon.setImageResource(R.drawable.tab_icon_book_light);
		...
		case 1:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_1);
			currIcon.setImageResource(R.drawable.tab_icon_search_light);
			currText = (TextView) mIndicators[which]
					.findViewWithTag(TAG_TEXT_1);
			break;
		case 2:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_2);
			currIcon.setImageResource(R.drawable.tab_icon_hot_light);
			currText = (TextView) mIndicators[which]
					.findViewWithTag(TAG_TEXT_2);
			break;
		case 3:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_3);
			currIcon.setImageResource(R.drawable.tab_icon_me_light);
			currText = (TextView) mIndicators[which]
					.findViewWithTag(TAG_TEXT_3);
			break;
		}
